...
;; fgallina/python.el
;;(require 'python (concat dotfiles-dir "extensions/python.el"))
...
;;   (setq
;;    python-shell-interpreter "foreman run ipython"
;;    python-shell-interpreter-args ""
;;    python-shell-prompt-regexp "In \[[0-9]+\]: "
;;    python-shell-prompt-output-regexp "Out\[[0-9]+\]: "
;;    python-shell-completion-setup-code "from Ipython.core.completerlib import module_completion"
;;    python-shell-completion-module-string-code "';'.join(module_completion('''%s'''))\n"
;;    python-shell-completion-string-code "';'.join(get_ipython().Completer('''%s'''))\n")
;;   )
...
(when (load-file (concat dotfiles-dir "elpa-to-submit/flymake-patch.el"))
